...
/**
 * Metadata built from {@link WebScaffoldMetadata}. A single {@link JspAssociationMetadata}
 * represents all JSPs for an associated controller. The metadata identifier for
 * a {@link JspAssociationMetadata} is the fully qualifier name of the controller, and the
 ...
 * @since 1.0
 */
public class JspAssociationMetadata extends AbstractMetadataItem {

    private static final String PROVIDES_TYPE_STRING = JspAssociationMetadata.class.getName();
    ...
    public JspAssociationMetadata(final String identifier,
